...
import { getHeroAction } from "../../redux/heroDucks";
      ...
      <div className="carta-box">
                ...
                <li className="list-group-item text-center">
                  ...
                  {hero.powerstats.combat !== "null" ? (
                    <div className="progress">
                      <div
                        className="progress-bar-yellow progress-bar-striped progress-bar-animated"
        ...
        <div className="container py-3 d-flex align-items-center carta-caja text-white d-flex justify-content-between">
          <button className="btn btn-primary">
            <Link
              onClick={() => dispatch(getHeroAction(hero.id))}
              to={`/details/${hero.id}`}
